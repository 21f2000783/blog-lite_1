...
class BlogAPI(Resource):
    ...
    def delete(self, blog_id):
        ...
        if blog.user_id == current_user.id:
            ...
            db.session.commit()
            return {'message' : " blog got deleted"}
        else:
...
class UserListAPI(Resource):
    ...
    # query parameter url.....?key=value&key2=value2
    @auth_required('token')
...
user_fields = {
    ...
    'num_followed' : fields.Integer,
    'num_post' : fields.Integer,
    'blogs' : fields.List(fields.Nested(blog_fields)),   # i want to send list blogs
 } 
...
api.add_resource(AllUserAPI, '/user')
